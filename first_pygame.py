...
BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'Grenade_1.wav'))
BULLET_FIRE_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'Gun_Silencer.wav'))

#BULLET_HIT_SOUND = pygame.mixer.Sound('Grenade_1.wav')
#BULLET_FIRE_SOUND = pygame.mixer.Sound('Gun_Silencer.wav')
...
YELLOW_SPACESHIP = pygame.transform.rotate(
    pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HIGHT)), 90)

RED_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'spaceship_red.png'))
RED_SPACESHIP = pygame.transform.rotate(
    pygame.transform.scale(RED_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HIGHT)), 270)
...
def yellow_handle_movment(keys_pressed, yellow):
    ...
    if keys_pressed[pygame.K_w] and yellow.y - VEL > 0:
        yellow.y -= VEL
    if keys_pressed[pygame.K_s] and yellow.y + yellow.height + VEL < HEIGHT - 5:
        yellow.y += VEL
...
def red_handle_movment(keys_pressed, red):
    ...
    if keys_pressed[pygame.K_UP] and red.y - VEL > 0:
        red.y -= VEL
    if keys_pressed[pygame.K_DOWN] and red.y + red.height + VEL < HEIGHT - 5:
        red.y += VEL
